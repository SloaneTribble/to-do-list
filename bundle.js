...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root.light{\n    --page-background: rgb(210, 210, 210);\n    --form-background: var(--page-background);\n    --font-color: black;\n    --border-color: black;\n}\n\n:root.dark{\n    --page-background: black;\n    --form-background: black;\n    --font-color: white;\n    --border-color: white;\n\n}\n\nhtml,\nbody{\n    box-sizing: border-box;\n    position: relative;\n    height: 100%;\n    margin: 0;\n    padding: 0; \n    color: var(--font-color);  \n}\n\nbody{\n    min-height: 100vh;\n    display: flex;\n    flex: 1;\n}\n*,\n*:before,\n*:after{\n    box-sizing: inherit;\n    max-width: 100vw;\n    margin: 0;\n}\n\nbutton {\n    display: inline-block;\n    border: 1px solid var(--border-color);\n    padding: 1rem 2rem;\n    margin: 0;\n    text-decoration: none;\n    background: var(--background-color);\n    color: var(--font-color);\n    font-family: sans-serif;\n    font-size: 1rem;\n    cursor: pointer;\n    text-align: center;\n    transition: background 250ms ease-in-out, \n                transform 150ms ease;\n    -webkit-appearance: none;\n    -moz-appearance: none;\n}\n\nbutton:hover,\nbutton:focus {\n    background: #0053ba;\n}\n\nbutton:focus {\n    outline: 1px solid #fff;\n    outline-offset: -4px;\n}\n\nbutton:active {\n    transform: scale(0.99);\n}\n\n.page-container{\n    min-height: 100vh;\n    min-width: 100vw;\n    background-color: var(--page-background);\n}\n\n.header{\n    border: 2px solid var(--border-color);\n    background-color: var(--background-color);\n    display: grid;\n    grid-template-columns: 3fr 4fr 2fr;\n}\n\n.title{\n    font-size: 2rem;\n    text-align: center;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n\n.project-form{\n    position: absolute;\n    background-color: white;\n    top: 32px;\n    left: 50%;\n    display: grid;\n}\n\n.project-details{\n    border-bottom-width: 3px;\n    display: grid;\n    justify-items: space-evenly;\n    grid-template-columns: repeat(7, 1fr);\n    grid-template-rows: 2fr 1fr;\n}\n\n.project-description{\n    border-top: solid 2px var(--border-color);\n    grid-row: 2;\n    grid-column: 1 / 8;\n    display: flex;\n    align-items: center;\n}\n\n.project-details > * {\n    padding: .1rem;\n}\n\n\n\n.to-do-button-container{\n    justify-self: center;\n    height: 100%;\n    width: 100%;\n    display: flex;\n    flex: 1;\n    align-items: center;\n    justify-content: center;\n    padding: 0;\n}\n\n.to-do-button-container > button{\n    flex: 1;\n    height: 100%;\n    width: 100%;\n    padding: 0;\n}\n\n\n.to-do-display{\n    background: rgb(65, 160, 255);\n    padding: 0;\n}\n\n.to-do-display:hover,\n.to-do-display:focus{\n    background: orangered;\n}\n\n.project-cell{\n    border: 3px solid var(--border-color);\n    font-size: 1.1rem;\n    padding: .5rem;\n}\n\n.to-do-list{\n    font-size: 1rem;\n}\n\n\n.to-do{\n    border: 2px solid var(--border-color);\n    display: grid;\n}\n\n.to-do > * {\n    padding: .5rem;\n}\n\n\n\n.to-do-header{\n    display: grid;\n    grid-template-columns: repeat(5, 1fr);\n    border-bottom: solid 1px var(--border-color);\n    align-items: center;\n}\n\n\n.high-priority{\n    background: linear-gradient(45deg,  var(--page-background), rgba(255, 99, 71, 0.4), rgba(255, 99, 71, 0.8));\n}\n\n.medium-priority{\n    background: linear-gradient(45deg,  var(--page-background), rgba(106, 90, 205, .4), rgba(106, 90, 205, .8));\n}\n\n.low-priority{\n    background: linear-gradient(45deg,  var(--page-background), rgba(60, 179, 113, 0.4), rgba(60, 179, 113, 0.8));\n}\n\n.form-container{\n    position: absolute;\n    top: 0;\n    z-index: 10;\n    height: 100vh;\n    width: 100vw;\n    background-color:rgba(0, 0, 0, 0.4);\n    display: flex;\n}\n\n.project-form{\n    font-size: 1.5rem;\n    min-height: 50%;\n    width: fit-content;\n    position: absolute;\n    top: 20%;\n    left: 0;\n    right: 0;\n    margin-left: auto;\n    margin-right: auto;\n    resize: none;\n    color: var(--font-color);\n    background: var(--form-background);\n    z-index: 10;\n    padding: 16px;\n}\n\ninput{\n    font-size: 1.2rem;\n}\n\n\n\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,qCAAqC;IACrC,yCAAyC;IACzC,mBAAmB;IACnB,qBAAqB;AACzB;;AAEA;IACI,wBAAwB;IACxB,wBAAwB;IACxB,mBAAmB;IACnB,qBAAqB;;AAEzB;;AAEA;;IAEI,sBAAsB;IACtB,kBAAkB;IAClB,YAAY;IACZ,SAAS;IACT,UAAU;IACV,wBAAwB;AAC5B;;AAEA;IACI,iBAAiB;IACjB,aAAa;IACb,OAAO;AACX;AACA;;;IAGI,mBAAmB;IACnB,gBAAgB;IAChB,SAAS;AACb;;AAEA;IACI,qBAAqB;IACrB,qCAAqC;IACrC,kBAAkB;IAClB,SAAS;IACT,qBAAqB;IACrB,mCAAmC;IACnC,wBAAwB;IACxB,uBAAuB;IACvB,eAAe;IACf,eAAe;IACf,kBAAkB;IAClB;oCACgC;IAChC,wBAAwB;IACxB,qBAAqB;AACzB;;AAEA;;IAEI,mBAAmB;AACvB;;AAEA;IACI,uBAAuB;IACvB,oBAAoB;AACxB;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,iBAAiB;IACjB,gBAAgB;IAChB,wCAAwC;AAC5C;;AAEA;IACI,qCAAqC;IACrC,yCAAyC;IACzC,aAAa;IACb,kCAAkC;AACtC;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,aAAa;IACb,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,kBAAkB;IAClB,uBAAuB;IACvB,SAAS;IACT,SAAS;IACT,aAAa;AACjB;;AAEA;IACI,wBAAwB;IACxB,aAAa;IACb,2BAA2B;IAC3B,qCAAqC;IACrC,2BAA2B;AAC/B;;AAEA;IACI,yCAAyC;IACzC,WAAW;IACX,kBAAkB;IAClB,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,cAAc;AAClB;;;;AAIA;IACI,oBAAoB;IACpB,YAAY;IACZ,WAAW;IACX,aAAa;IACb,OAAO;IACP,mBAAmB;IACnB,uBAAuB;IACvB,UAAU;AACd;;AAEA;IACI,OAAO;IACP,YAAY;IACZ,WAAW;IACX,UAAU;AACd;;;AAGA;IACI,6BAA6B;IAC7B,UAAU;AACd;;AAEA;;IAEI,qBAAqB;AACzB;;AAEA;IACI,qCAAqC;IACrC,iBAAiB;IACjB,cAAc;AAClB;;AAEA;IACI,eAAe;AACnB;;;AAGA;IACI,qCAAqC;IACrC,aAAa;AACjB;;AAEA;IACI,cAAc;AAClB;;;;AAIA;IACI,aAAa;IACb,qCAAqC;IACrC,4CAA4C;IAC5C,mBAAmB;AACvB;;;AAGA;IACI,2GAA2G;AAC/G;;AAEA;IACI,2GAA2G;AAC/G;;AAEA;IACI,6GAA6G;AACjH;;AAEA;IACI,kBAAkB;IAClB,MAAM;IACN,WAAW;IACX,aAAa;IACb,YAAY;IACZ,mCAAmC;IACnC,aAAa;AACjB;;AAEA;IACI,iBAAiB;IACjB,eAAe;IACf,kBAAkB;IAClB,kBAAkB;IAClB,QAAQ;IACR,OAAO;IACP,QAAQ;IACR,iBAAiB;IACjB,kBAAkB;IAClB,YAAY;IACZ,wBAAwB;IACxB,kCAAkC;IAClC,WAAW;IACX,aAAa;AACjB;;AAEA;IACI,iBAAiB;AACrB","sourcesContent":[":root.light{\n    --page-background: rgb(210, 210, 210);\n    --form-background: var(--page-background);\n    --font-color: black;\n    --border-color: black;\n}\n\n:root.dark{\n    --page-background: black;\n    --form-background: black;\n    --font-color: white;\n    --border-color: white;\n\n}\n\nhtml,\nbody{\n    box-sizing: border-box;\n    position: relative;\n    height: 100%;\n    margin: 0;\n    padding: 0; \n    color: var(--font-color);  \n}\n\nbody{\n    min-height: 100vh;\n    display: flex;\n    flex: 1;\n}\n*,\n*:before,\n*:after{\n    box-sizing: inherit;\n    max-width: 100vw;\n    margin: 0;\n}\n\nbutton {\n    display: inline-block;\n    border: 1px solid var(--border-color);\n    padding: 1rem 2rem;\n    margin: 0;\n    text-decoration: none;\n    background: var(--background-color);\n    color: var(--font-color);\n    font-family: sans-serif;\n    font-size: 1rem;\n    cursor: pointer;\n    text-align: center;\n    transition: background 250ms ease-in-out, \n                transform 150ms ease;\n    -webkit-appearance: none;\n    -moz-appearance: none;\n}\n\nbutton:hover,\nbutton:focus {\n    background: #0053ba;\n}\n\nbutton:focus {\n    outline: 1px solid #fff;\n    outline-offset: -4px;\n}\n\nbutton:active {\n    transform: scale(0.99);\n}\n\n.page-container{\n    min-height: 100vh;\n    min-width: 100vw;\n    background-color: var(--page-background);\n}\n\n.header{\n    border: 2px solid var(--border-color);\n    background-color: var(--background-color);\n    display: grid;\n    grid-template-columns: 3fr 4fr 2fr;\n}\n\n.title{\n    font-size: 2rem;\n    text-align: center;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n\n.project-form{\n    position: absolute;\n    background-color: white;\n    top: 32px;\n    left: 50%;\n    display: grid;\n}\n\n.project-details{\n    border-bottom-width: 3px;\n    display: grid;\n    justify-items: space-evenly;\n    grid-template-columns: repeat(7, 1fr);\n    grid-template-rows: 2fr 1fr;\n}\n\n.project-description{\n    border-top: solid 2px var(--border-color);\n    grid-row: 2;\n    grid-column: 1 / 8;\n    display: flex;\n    align-items: center;\n}\n\n.project-details > * {\n    padding: .1rem;\n}\n\n\n\n.to-do-button-container{\n    justify-self: center;\n    height: 100%;\n    width: 100%;\n    display: flex;\n    flex: 1;\n    align-items: center;\n    justify-content: center;\n    padding: 0;\n}\n\n.to-do-button-container > button{\n    flex: 1;\n    height: 100%;\n    width: 100%;\n    padding: 0;\n}\n\n\n.to-do-display{\n    background: rgb(65, 160, 255);\n    padding: 0;\n}\n\n.to-do-display:hover,\n.to-do-display:focus{\n    background: orangered;\n}\n\n.project-cell{\n    border: 3px solid var(--border-color);\n    font-size: 1.1rem;\n    padding: .5rem;\n}\n\n.to-do-list{\n    font-size: 1rem;\n}\n\n\n.to-do{\n    border: 2px solid var(--border-color);\n    display: grid;\n}\n\n.to-do > * {\n    padding: .5rem;\n}\n\n\n\n.to-do-header{\n    display: grid;\n    grid-template-columns: repeat(5, 1fr);\n    border-bottom: solid 1px var(--border-color);\n    align-items: center;\n}\n\n\n.high-priority{\n    background: linear-gradient(45deg,  var(--page-background), rgba(255, 99, 71, 0.4), rgba(255, 99, 71, 0.8));\n}\n\n.medium-priority{\n    background: linear-gradient(45deg,  var(--page-background), rgba(106, 90, 205, .4), rgba(106, 90, 205, .8));\n}\n\n.low-priority{\n    background: linear-gradient(45deg,  var(--page-background), rgba(60, 179, 113, 0.4), rgba(60, 179, 113, 0.8));\n}\n\n.form-container{\n    position: absolute;\n    top: 0;\n    z-index: 10;\n    height: 100vh;\n    width: 100vw;\n    background-color:rgba(0, 0, 0, 0.4);\n    display: flex;\n}\n\n.project-form{\n    font-size: 1.5rem;\n    min-height: 50%;\n    width: fit-content;\n    position: absolute;\n    top: 20%;\n    left: 0;\n    right: 0;\n    margin-left: auto;\n    margin-right: auto;\n    resize: none;\n    color: var(--font-color);\n    background: var(--form-background);\n    z-index: 10;\n    padding: 16px;\n}\n\ninput{\n    font-size: 1.2rem;\n}\n\n\n\n"],"sourceRoot":""}]);
// Exports
