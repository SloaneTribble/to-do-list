...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root.light{\n    --page-background: white;\n}\n\n:root.dark{\n    --page-background: black;\n}\n\nhtml,\nbody{\n    box-sizing: border-box;\n    position: relative;\n    height: 100%;\n    margin: 0;\n    padding: 0;   \n}\n\nbody{\n    min-height: 100vh;\n    display: flex;\n    flex: 1;\n}\n*,\n*:before,\n*:after{\n    box-sizing: inherit;\n    max-width: 100vw;\n    margin: 0;\n}\n\nbutton {\n    display: inline-block;\n    border: 1px solid black;\n    padding: 1rem 2rem;\n    margin: 0;\n    text-decoration: none;\n    background: #0069ed;\n    color: #ffffff;\n    font-family: sans-serif;\n    font-size: 1rem;\n    cursor: pointer;\n    text-align: center;\n    transition: background 250ms ease-in-out, \n                transform 150ms ease;\n    -webkit-appearance: none;\n    -moz-appearance: none;\n}\n\nbutton:hover,\nbutton:focus {\n    background: #0053ba;\n}\n\nbutton:focus {\n    outline: 1px solid #fff;\n    outline-offset: -4px;\n}\n\nbutton:active {\n    transform: scale(0.99);\n}\n\n.page-container{\n    min-height: 100vh;\n    min-width: 100vw;\n    background-color: var(--page-background);\n}\n\n.header{\n    border: 2px solid black;\n    background-color: aqua;\n    display: grid;\n    grid-template-columns: 2fr 4fr 2fr;\n}\n\n.project-form{\n    position: absolute;\n    background-color: white;\n    top: 32px;\n    left: 50%;\n    display: grid;\n}\n\n.project-details{\n    border-bottom-width: 3px;\n    display: grid;\n    justify-items: space-evenly;\n    grid-template-columns: repeat(7, 1fr);\n    grid-template-rows: 2fr 1fr;\n}\n\n.project-description{\n    border-top: solid 2px black;\n    grid-row: 2;\n    grid-column: 1 / 8;\n    display: flex;\n    align-items: center;\n}\n\n.project-details > * {\n    padding: .1rem;\n}\n\n\n\n.to-do-button-container{\n    justify-self: center;\n    height: 100%;\n    width: 100%;\n    display: flex;\n    flex: 1;\n    align-items: center;\n    justify-content: center;\n    border: none;\n}\n\n.to-do-button-container > button{\n    flex: 1;\n    height: 100%;\n    width: 100%;\n    padding: 0;\n}\n\n\n.to-do-display{\n    background: rgb(127, 191, 255);\n}\n\n.to-do-display:hover,\n.to-do-display:focus{\n    background: orangered;\n}\n\n.project-cell{\n    border: 3px solid black;\n    font-size: 1.1rem;\n    padding: .5rem;\n}\n\n.to-do-list{\n    font-size: 1rem;\n}\n\n\n.to-do{\n    border: 2px solid black;\n    display: grid;\n}\n\n.to-do > * {\n    padding: .5rem;\n}\n\n\n\n.to-do-header{\n    display: grid;\n    grid-template-columns: repeat(5, 1fr);\n    border-bottom: solid 1px black;\n    align-items: center;\n}\n\n\n.high-priority{\n    background: linear-gradient(45deg,  white, rgba(255, 99, 71, 0.4));\n}\n\n.medium-priority{\n    background: linear-gradient(45deg,  white, rgba(106, 90, 205, .4));\n}\n\n.low-priority{\n    background: linear-gradient(45deg,  white, rgba(60, 179, 113, 0.4));\n}\n\n.form-container{\n    position: absolute;\n    top: 0;\n    z-index: 10;\n    height: 100vh;\n    width: 100vw;\n    background-color:rgba(0, 0, 0, 0.4);\n}\n\n.project-form{\n    height: fit-content;\n    width: fit-content;\n    resize: none;\n}\n\n\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,wBAAwB;AAC5B;;AAEA;IACI,wBAAwB;AAC5B;;AAEA;;IAEI,sBAAsB;IACtB,kBAAkB;IAClB,YAAY;IACZ,SAAS;IACT,UAAU;AACd;;AAEA;IACI,iBAAiB;IACjB,aAAa;IACb,OAAO;AACX;AACA;;;IAGI,mBAAmB;IACnB,gBAAgB;IAChB,SAAS;AACb;;AAEA;IACI,qBAAqB;IACrB,uBAAuB;IACvB,kBAAkB;IAClB,SAAS;IACT,qBAAqB;IACrB,mBAAmB;IACnB,cAAc;IACd,uBAAuB;IACvB,eAAe;IACf,eAAe;IACf,kBAAkB;IAClB;oCACgC;IAChC,wBAAwB;IACxB,qBAAqB;AACzB;;AAEA;;IAEI,mBAAmB;AACvB;;AAEA;IACI,uBAAuB;IACvB,oBAAoB;AACxB;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,iBAAiB;IACjB,gBAAgB;IAChB,wCAAwC;AAC5C;;AAEA;IACI,uBAAuB;IACvB,sBAAsB;IACtB,aAAa;IACb,kCAAkC;AACtC;;AAEA;IACI,kBAAkB;IAClB,uBAAuB;IACvB,SAAS;IACT,SAAS;IACT,aAAa;AACjB;;AAEA;IACI,wBAAwB;IACxB,aAAa;IACb,2BAA2B;IAC3B,qCAAqC;IACrC,2BAA2B;AAC/B;;AAEA;IACI,2BAA2B;IAC3B,WAAW;IACX,kBAAkB;IAClB,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,cAAc;AAClB;;;;AAIA;IACI,oBAAoB;IACpB,YAAY;IACZ,WAAW;IACX,aAAa;IACb,OAAO;IACP,mBAAmB;IACnB,uBAAuB;IACvB,YAAY;AAChB;;AAEA;IACI,OAAO;IACP,YAAY;IACZ,WAAW;IACX,UAAU;AACd;;;AAGA;IACI,8BAA8B;AAClC;;AAEA;;IAEI,qBAAqB;AACzB;;AAEA;IACI,uBAAuB;IACvB,iBAAiB;IACjB,cAAc;AAClB;;AAEA;IACI,eAAe;AACnB;;;AAGA;IACI,uBAAuB;IACvB,aAAa;AACjB;;AAEA;IACI,cAAc;AAClB;;;;AAIA;IACI,aAAa;IACb,qCAAqC;IACrC,8BAA8B;IAC9B,mBAAmB;AACvB;;;AAGA;IACI,kEAAkE;AACtE;;AAEA;IACI,kEAAkE;AACtE;;AAEA;IACI,mEAAmE;AACvE;;AAEA;IACI,kBAAkB;IAClB,MAAM;IACN,WAAW;IACX,aAAa;IACb,YAAY;IACZ,mCAAmC;AACvC;;AAEA;IACI,mBAAmB;IACnB,kBAAkB;IAClB,YAAY;AAChB","sourcesContent":[":root.light{\n    --page-background: white;\n}\n\n:root.dark{\n    --page-background: black;\n}\n\nhtml,\nbody{\n    box-sizing: border-box;\n    position: relative;\n    height: 100%;\n    margin: 0;\n    padding: 0;   \n}\n\nbody{\n    min-height: 100vh;\n    display: flex;\n    flex: 1;\n}\n*,\n*:before,\n*:after{\n    box-sizing: inherit;\n    max-width: 100vw;\n    margin: 0;\n}\n\nbutton {\n    display: inline-block;\n    border: 1px solid black;\n    padding: 1rem 2rem;\n    margin: 0;\n    text-decoration: none;\n    background: #0069ed;\n    color: #ffffff;\n    font-family: sans-serif;\n    font-size: 1rem;\n    cursor: pointer;\n    text-align: center;\n    transition: background 250ms ease-in-out, \n                transform 150ms ease;\n    -webkit-appearance: none;\n    -moz-appearance: none;\n}\n\nbutton:hover,\nbutton:focus {\n    background: #0053ba;\n}\n\nbutton:focus {\n    outline: 1px solid #fff;\n    outline-offset: -4px;\n}\n\nbutton:active {\n    transform: scale(0.99);\n}\n\n.page-container{\n    min-height: 100vh;\n    min-width: 100vw;\n    background-color: var(--page-background);\n}\n\n.header{\n    border: 2px solid black;\n    background-color: aqua;\n    display: grid;\n    grid-template-columns: 2fr 4fr 2fr;\n}\n\n.project-form{\n    position: absolute;\n    background-color: white;\n    top: 32px;\n    left: 50%;\n    display: grid;\n}\n\n.project-details{\n    border-bottom-width: 3px;\n    display: grid;\n    justify-items: space-evenly;\n    grid-template-columns: repeat(7, 1fr);\n    grid-template-rows: 2fr 1fr;\n}\n\n.project-description{\n    border-top: solid 2px black;\n    grid-row: 2;\n    grid-column: 1 / 8;\n    display: flex;\n    align-items: center;\n}\n\n.project-details > * {\n    padding: .1rem;\n}\n\n\n\n.to-do-button-container{\n    justify-self: center;\n    height: 100%;\n    width: 100%;\n    display: flex;\n    flex: 1;\n    align-items: center;\n    justify-content: center;\n    border: none;\n}\n\n.to-do-button-container > button{\n    flex: 1;\n    height: 100%;\n    width: 100%;\n    padding: 0;\n}\n\n\n.to-do-display{\n    background: rgb(127, 191, 255);\n}\n\n.to-do-display:hover,\n.to-do-display:focus{\n    background: orangered;\n}\n\n.project-cell{\n    border: 3px solid black;\n    font-size: 1.1rem;\n    padding: .5rem;\n}\n\n.to-do-list{\n    font-size: 1rem;\n}\n\n\n.to-do{\n    border: 2px solid black;\n    display: grid;\n}\n\n.to-do > * {\n    padding: .5rem;\n}\n\n\n\n.to-do-header{\n    display: grid;\n    grid-template-columns: repeat(5, 1fr);\n    border-bottom: solid 1px black;\n    align-items: center;\n}\n\n\n.high-priority{\n    background: linear-gradient(45deg,  white, rgba(255, 99, 71, 0.4));\n}\n\n.medium-priority{\n    background: linear-gradient(45deg,  white, rgba(106, 90, 205, .4));\n}\n\n.low-priority{\n    background: linear-gradient(45deg,  white, rgba(60, 179, 113, 0.4));\n}\n\n.form-container{\n    position: absolute;\n    top: 0;\n    z-index: 10;\n    height: 100vh;\n    width: 100vw;\n    background-color:rgba(0, 0, 0, 0.4);\n}\n\n.project-form{\n    height: fit-content;\n    width: fit-content;\n    resize: none;\n}\n\n\n"],"sourceRoot":""}]);
// Exports
